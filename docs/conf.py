...
package = "birds"
project = "birds"
version = birds.__version__
copyright = '2023, Arnau Quera-Bofarull, Joel Dyer, Ayush Chopra'
repository = "https://github.com/arnauqb/birds"
author = 'Arnau Quera-Bofarull, Joel Dyer, Ayush Chopra'
release = '0.1'
...
def linkcode_resolve(domain: str, info: dict) -> str:
    ...
    try:
        ...
        return f"{repository}/blob/{release}/{file}#L{start}-L{end}"
